package noobanidus.mods.lootrmentaries.common.entity;
...
// TODO:
public class LootrFallingUrnEntity extends ImprovedFallingBlockEntity {
  public static Supplier<EntityType<LootrFallingUrnEntity>> type;

  public LootrFallingUrnEntity(EntityType<LootrFallingUrnEntity> type, Level level) {
    super(type, level);
  }

  public LootrFallingUrnEntity(Level level, BlockPos pos, BlockState blockState) {
    super(type.get(), level, pos, blockState, false);
    this.setHurtsEntities(1f, 20);
  }

  public static LootrFallingUrnEntity fall(Level level, BlockPos pos, BlockState state) {
    LootrFallingUrnEntity entity = new LootrFallingUrnEntity(level, pos, state);
